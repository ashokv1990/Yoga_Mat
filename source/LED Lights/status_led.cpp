...
int main()
{
    ...
    while (1) {
        /*if((sw1 == 1) && (sw2 == 1) && (sw3 == 1)) {
            for(col = 26-1; col < 85; col++) {
                strip.setPixelColor(col, strip.Color(0,125,125));
                strip.show();
            }
        } else if((sw1 == 1) && (sw2 == 1)) {
            for(col = 46-1; col < 85; col++) {
                strip.setPixelColor(col, strip.Color(0,125,125));
                strip.show();
            }
            for(col = 26-1; col < 45; col++) {
                strip.setPixelColor(col, strip.Color(0,0,0));
                strip.show();
            }
        }   else if((sw2 == 1) && (sw3 == 1)) {
            for(col = 26-1; col < 65; col++) {
                strip.setPixelColor(col, strip.Color(0,125,125));
                strip.show();
            }
            for(col = 66-1; col < 85; col++) {
                strip.setPixelColor(col, strip.Color(0,0,0));
                strip.show();
            }
        } else if((sw1 == 1) && (sw3 == 1)) {
        ...
        if(a1 > 0.9 && a3 > 0.9 && a2 > 0.9)
    {
     ...
     for(col = 8; col < 16; col++) {
                strip.setPixelColor(col, strip.Color(0,125,0));
                strip.show();
    }
    for(col = 16; col < 24; col++) {
                strip.setPixelColor(col, strip.Color(125,0,0));
               // strip.setPixelColor(col, strip.Color(0,0,0));
                strip.show();
    }
  
  }    
       else if(a1 > 0.9 && a3 > 0.9)
    {
        for(col = 0; col < 8; col++) {
                //strip.setPixelColor(col, strip.Color(0,125,125));
                strip.setPixelColor(col, strip.Color(0,0,0));
